...
Agents MUST use the `autonomous-ops.sh` script (located in the repository root) to manage the development lifecycle. Direct use of git commands for merging or pushing is discouraged in favor of the script's automated checks.
